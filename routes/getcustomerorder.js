...
router.get('/',(req,res,next)=>{
    var id=req.query.id;
    var query=`SELECT OrderDetails.Id,CustomerOrder.OrderId,Products.ProductImage, seller.Name AS SellerName, users.username, OrderDetails.ProductId, OrderDetails.Quantity, OrderDetails.ProductSize, OrderDetails.ProductColor, OrderDetails.TotalPrice, OrderDetails.DiscountPercentage, OrderDetails.OrderDate, Products.ProductName, (OrderDetails.TotalPrice * 0.9) AS PricetoSeller, (OrderDetails.TotalPrice * 0.1) AS PricetoAdmin, PaymentDetails.PaymentStatusId AS PaymentStatus
    FROM OrderDetails
